...
**/
//var app = angular.module('MyApp', ['ngMaterial', 'ngMdIcons', 'ngMessages', 'ngStorage', uiRouter, mdDataTable]);
...
app.controller('newsController', ['$mdEditDialog', '$q', '$scope', '$timeout', function ($mdEditDialog, $q, $scope, $timeout) {
    'use strict';
...
app.controller('newsDetailCtrl', function ($scope, $element) {
